...
#define ANDROID_CAMERA_INPUT_THREADSAFE_CALLBACK_H_INCLUDED
...
const char CameraInputCallbackAOName[] = "CameraInputTSCAO_Name";

class AndroidCameraInputThreadSafeCallbackAO : public ThreadSafeCallbackAO
{
public:
    //Constructor
    AndroidCameraInputThreadSafeCallbackAO(void* aObserver = NULL,
                                           uint32 aDepth=10,
                                           const char* aAOname = CameraInputCallbackAOName,
...
#endif
    virtual ~AndroidCameraInputThreadSafeCallbackAO();
    ThreadSafeMemPoolFixedChunkAllocator *iMemoryPool;
};

}; // namespace android

#endif //ANDROID_CAMERA_INPUT_THREADSAFE_CALLBACK_H_INCLUDED
