...
#ifndef __EVRCDecoderSpecificInfo3GPP2_H__
#define __EVRCDecoderSpecificInfo3GPP2_H__
...
class PVA_FF_EVRCSpecificAtom : public PVA_FF_Atom
{

    public:
        PVA_FF_EVRCSpecificAtom(); // Default constructor
        virtual ~PVA_FF_EVRCSpecificAtom() {}; // Destructor
