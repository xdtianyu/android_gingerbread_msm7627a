...
#define GPP_EVRCDECODERSPECIFICINFO_H_INCLUDED
...
class EVRCSpecificAtom : public Atom
{

    public:
        EVRCSpecificAtom(MP4_FF_FILE *fp, uint32 size, uint32 type); // Default constructor
        virtual ~EVRCSpecificAtom() {}; // Destructor
...
#endif // GPP_EVRCDECODERSPECIFICINFO_H_INCLUDED
