 ...
 * -------------------------------------------------------------------
 */
#ifndef PVQCPFFREC_PLUGIN_H_INCLUDED
#define PVQCPFFREC_PLUGIN_H_INCLUDED

#ifndef PVMF_RECOGNIZER_PLUGIN_H_INCLUDED
#include "pvmf_recognizer_plugin.h"
#endif

#define QCPFF_MIN_DATA_SIZE_FOR_RECOGNITION 194

class PVQCPFFRecognizerPlugin : public PVMFRecognizerPluginInterface
{
    public:
        PVQCPFFRecognizerPlugin()
        {
        };
...
#endif // PVQCPFFREC_PLUGIN_H_INCLUDED
