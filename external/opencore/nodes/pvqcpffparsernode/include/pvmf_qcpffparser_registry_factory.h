 ...
 * -------------------------------------------------------------------
 */
#ifndef PVMF_QCPFFPARSER_REGISTRY_FACTORY_H_INCLUDED
#define PVMF_QCPFFPARSER_REGISTRY_FACTORY_H_INCLUDED
...
class PVMFQCPFFParserNodeRegistryFactory: public PVMFNodeCreationInterface
            , public PvmiCapabilityAndConfig
{
    public:
        ...
        */
        ...
        {
            info.iUuid = KPVMFQcpFFParserNodeUuid;
            ...
            info.iCapability.AddInputFormat("multiplexed/x-qcp-ff");
        }
        ...
        PVMFNodeInterface* CreateNode(OsclAny*aParam = NULL)
        {
            ...
            return PVMFQCPFFParserNodeFactory::CreatePVMFQCPFFParserNode();
        }
        void ReleaseNode(PVMFNodeInterface* aNode)
        {
            PVMFQCPFFParserNodeFactory::DeletePVMFQCPFFParserNode(aNode);
        }
...
#endif // PVMF_QCPFFPARSER_REGISTRY_FACTORY_H_INCLUDED
