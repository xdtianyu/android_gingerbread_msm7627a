...
static int add_mas_one(sdp_session_t *session, svc_info_t *si)
{
	sdp_list_t *svclass_id, *pfseq, *apseq, *root;
	uuid_t root_uuid, ftrn_uuid, l2cap_uuid, rfcomm_uuid, obex_uuid;
	...
	sdp_set_info_attr(&record, "OBEX Message Access One", 0, 0);
...
struct {
	...
	{ "PRINT",	DIRECT_PRINTING_SVCLASS_ID,	add_directprint	},
        { "MASZERO",        OBEX_MAP_SVCLASS_ID,            add_mas         },
	...
	{ "MASONE",	OBEX_MAP_SVCLASS_ID, 	add_mas_one },
