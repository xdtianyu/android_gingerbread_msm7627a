...
// arg4 int length
//
static bool javaLangString_regionMatches(u4 arg0, u4 arg1, u4 arg2, u4 arg3,
    JValue* pResult, u4 arg4)
{
    int thisStart = (int) arg1;
    int start = (int) arg3;
    int length = (int) arg4;
    /*
     * Null reference check on "this".
    ...
    if (!dvmValidateObject((Object*) arg2))
        return false;
    ...
    /* quick length check */
    thisCount = dvmGetFieldInt((Object*) arg0, STRING_FIELDOFF_COUNT);
    compCount = dvmGetFieldInt((Object*) arg2, STRING_FIELDOFF_COUNT);

    if( start < 0 || ((compCount - start) < length) ){
        pResult->i = false;
        return true;
    }

    if( thisStart < 0 || (thisCount - thisStart) < length ){
        pResult->i = false;
        return true;
    }
    ...
    thisOffset = dvmGetFieldInt((Object*) arg0, STRING_FIELDOFF_OFFSET);
    compOffset = dvmGetFieldInt((Object*) arg2, STRING_FIELDOFF_OFFSET);

    thisArray = (ArrayObject*)
        dvmGetFieldObject((Object*) arg0, STRING_FIELDOFF_VALUE);
    compArray = (ArrayObject*)
        dvmGetFieldObject((Object*) arg2, STRING_FIELDOFF_VALUE);
    thisChars = ((const u2*) thisArray->contents) + thisOffset + thisStart ;
    compChars = ((const u2*) compArray->contents) + compOffset + start;

#ifdef HAVE__MEMCMP16
    pResult->i = (__memcmp16(thisChars, compChars, length) == 0);
# ifdef CHECK_MEMCMP16
    int otherRes = (memcmp(thisChars, compChars, length * 2) == 0);
    if (pResult->i != otherRes) {
        badMatch((StringObject*) arg0, (StringObject*) arg1,
            otherRes, pResult->i, "regtionMatches-1");
    }
# endif
#else
    /*
...
#ifdef INLINE_ARG5
    { (InlineOp4Func)javaLangString_regionMatches,
    ...
    JValue* pResult, int opIndex, u4 arg4)
{
    ...
    TRACE_METHOD_ENTER(self, method);
    result = ((InlineOp5Func)(*gDvmInlineOpsTable[opIndex].func))(arg0, arg1, arg2, arg3,
            pResult, arg4);
