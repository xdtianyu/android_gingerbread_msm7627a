...
public class Main {
    ...
    static public boolean checkTimes(double[][] timings, boolean print) {
        ...
        double[][] expected = {
            {  1.0,  2.3,  2.4,  3.3,  7.5, 12.0, 57.0,  94.0 },
            {  1.2,  2.4,  2.5,  3.4,  7.6, 12.2, 60.0,  95.0 },
            {  1.5,  2.6,  2.9,  3.5,  7.7, 12.4, 63.0,  96.0 },
            {  1.6,  2.8,  2.9,  3.6,  8.8, 12.6, 63.5,  97.0 },
            {  1.7,  3.0,  2.9,  3.7,  8.9, 12.8, 64.0,  98.0 },
