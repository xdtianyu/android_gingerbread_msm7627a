...
public class Main {
    ...
    public static void stringCompareToTest() {
        ...
        Assert.assertTrue(test.startsWith(ssub));
        Assert.assertTrue(test.endsWith(esub));
        Assert.assertFalse(test.endsWith(ssub));
        Assert.assertFalse(test.startsWith(esub));
