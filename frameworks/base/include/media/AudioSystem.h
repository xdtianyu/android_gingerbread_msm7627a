...
public:
    ...
    enum audio_devices {
        ...
        DEVICE_OUT_AUX_HDMI = 0x800,
        DEVICE_OUT_FM = 0x1000,
        DEVICE_OUT_ANC_HEADSET = 0x2000,
        DEVICE_OUT_ANC_HEADPHONE = 0x4000,
        DEVICE_OUT_FM_TX = 0x8000,
        DEVICE_OUT_ANALOG_FM = 0x10000,
        DEVICE_OUT_ANALOG_FM_CODEC = 0x20000,
        DEVICE_OUT_DEFAULT = 0x40000,
        DEVICE_OUT_ALL = (DEVICE_OUT_EARPIECE | DEVICE_OUT_SPEAKER | DEVICE_OUT_WIRED_HEADSET |
                ...
                DEVICE_OUT_BLUETOOTH_A2DP_SPEAKER | DEVICE_OUT_AUX_DIGITAL | DEVICE_OUT_AUX_HDMI | DEVICE_OUT_FM |
                DEVICE_OUT_ANC_HEADSET | DEVICE_OUT_ANC_HEADPHONE | DEVICE_OUT_FM_TX | DEVICE_OUT_ANALOG_FM |
                DEVICE_OUT_DEFAULT),
        ...
        DEVICE_IN_ANC_HEADSET = 0x400000,
