...
public class CallIndependentServices extends PreferenceActivity
    ...
    private final int mResources[] = {R.xml.call_independent_services, R.xml.call_independent_services_multi_sim};
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (selectSub != null) {
            ...
            intent.putExtra(MultiSimSetting.PACKAGE, "com.android.phone");
            intent.putExtra(MultiSimSetting.TARGET_CLASS, "com.android.phone.CallFeaturesSetting");
        }
    }
