...
public class MobileNetworkSettings extends PreferenceActivity implements DialogInterface.OnClickListener,
    ...
    private final int mResources[] = {R.xml.mobile_network_setting, R.xml.mobile_network_setting_multi_sim};
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (manageSub != null) {
            ...
            intent.putExtra(MultiSimSetting.TARGET_CLASS, "com.android.phone.Settings");
        }
