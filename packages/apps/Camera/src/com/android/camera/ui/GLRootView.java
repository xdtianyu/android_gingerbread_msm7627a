...
public class GLRootView extends GLSurfaceView
    ...
    public void clearClip() {
        //Set scissor to the largest size (i.e. screen size) to clear old scissors.
        DisplayMetrics displaySize = getDisplayMetrics();
        int maxSize = displaySize.widthPixels > displaySize.heightPixels ?
                displaySize.widthPixels :displaySize.heightPixels;
        mGL.glScissor(0, 0, maxSize, maxSize);
    }
